...
def get_model_paths(ticker):
    ticker = ticker.upper()
    # NEW: multivariate model saved separately from old single-feature model
    model_path  = os.path.join(MODEL_DIR, f"{ticker}_mv_model.keras")
    scaler_path = os.path.join(MODEL_DIR, f"{ticker}_mv_scaler.pkl")
